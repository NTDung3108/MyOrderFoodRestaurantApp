...
public class OTPVerifyActivity extends AppCompatActivity {
    ...
    String phoneNumber, verificationId, phone, status;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(@NonNull String newVerificationId, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                Toast.makeText(OTPVerifyActivity.this, "OTP Send", Toast.LENGTH_SHORT).show();
            }
        };
    }
    ...
    private void sendToRegisterAccount(){
        if (status.equals("ForgotPassword")){
            Intent registerIntent = new Intent(getApplicationContext(), ForgotPasswordActivity.class);
